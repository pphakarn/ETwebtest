...
const StaffSwitcher = () => {
    ...
    return (
        <div className="w-full bg-gray-400 backdrop-blur-md py-6">
            <div className="container mx-auto px-4">
                <h3 className="text-center text-blue-50 text-s font-semibold mb-4 tracking-wider uppercase">
                    ดูบุคลากรท่านอื่น
                </h3>
                <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                    {personnelData.map((person, index) => {
                        ...
                        return (
                            ...
                            >
                                <motion.div 
                                    className={`relative w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden border-2 transition-all duration-200 ${
                                ...
                                <span className={`text-[10px] md:text-sm font-medium transition-colors duration-300 ${
                                    isActive ? 'text-[#3FA2F6]' : 'text-blue-50 group-hover:text-gray-600'
                                }`}>
                                    {person.alt}
                                </span>
                            </Link>
